...
privateHistory_F::privateHistory_F(std::string filepath,int s, int gh, int ph){
...
void privateHistory_F::begin_prediction_P(){
  ...
  std::ofstream results_file ("results/result_sum_pshare.txt", std::ofstream::out);       // result file write
